...
production, resultsdict = gulden(case='samuelson_model', countries=countries, count=count, industries=industries, P=P, A=A, alpha=alpha, beta=beta, 
                                 total_time = 2000, trade_time = 500, pd_time=1000, shock=shock, cm_time=6000, autarky_time=5000,
...
production, resultsdict = gulden(case='capmob_model', countries=countries, count=count, industries=industries, P=P, A=A, alpha=alpha, beta=beta, 
