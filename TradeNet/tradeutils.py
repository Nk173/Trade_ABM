...
def doAllTrades(trade_volume, S, prices, trade_change):  
...
def doOneTrade(trade_volume, S, net_exports, prices, industry, c2, c1, trade_change):
...
#     target_trade_change = trade_change
    target_trade_change = S[exporterName, industry]*trade_change
#     print(target_trade_change)
#     money_exchanged = prices[exporterName, industry]*target_trade_change
    money_exchanged = prices[exporterName, industry]*trade_change
